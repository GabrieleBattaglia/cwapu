# CWapu, costruttore del dizionario personale.
...
def Start(words_path=None, output_dir=None):
    ...
    if not os.path.exists(words_path):
        print(f"Error: words.txt not found: {words_path}")
        return
    ...
    percorso_uscita = os.path.join(output_dir, "words_updated.txt")
    SaveDictionary(initial_dictionary, percorso_uscita)
