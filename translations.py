...
translations = {
	'en': {
		"no_data_to_analyze": "No data to analyze.",
		"summary_title": "--- Activity Summary ---",
		"total_sessions_info": "Total sessions analyzed: {count}",
		"period_covered_info": "Period covered: {days} days",
		"first_session_info": "First session: {date}",
		"last_session_info": "Last session: {date}",
		"hourly_distribution_title": "\n--- Hourly Session Distribution ---",
		"hourly_distribution_line": "  - Hour {hour_start:02d}:00: {count} sessions ({percentage:.1f}%)",
		"hourly_peak_activity": "Peak activity hour: {hour:02d}:00.",
		"weekly_distribution_title": "\n--- Weekly Distribution ---",
		"weekly_distribution_line": "  - {day_name}: {count} sessions ({percentage:.1f}%)",
		"weekly_peak_activity": "Peak activity day: {day_name}.",
		"monthly_distribution_title": "\n--- Monthly Distribution ---",
		"monthly_distribution_line": "  - {month_name}: {count} sessions ({percentage:.1f}%)",
		"monthly_peak_activity": "Peak activity month: {month_name}.",
		"giorni_settimana_dict": {"0": "Monday", "1": "Tuesday", "2": "Wednesday", "3": "Thursday", "4": "Friday", "5": "Saturday", "6": "Sunday"},
		"mesi_anno_dict": {"1": "January", "2": "February", "3": "March", "4": "April", "5": "May", "6": "June", "7": "July", "8": "August", "9": "September", "10": "October", "11": "November", "12": "December"},
		"no_performance_data": "No performance data to analyze.",
		"wpm_analysis_title": "--- Performance Analysis: Speed (WPM) ---",
		"overall_avg_wpm": "Overall average speed: {wpm:.1f} WPM.",
		"overall_wpm_consistency": "Consistency (std. dev.): {std:.1f} WPM.",
		"wpm_trend_report": "Trend: average WPM went from {half1:.1f} (first half) to {half2:.1f} (second half). Trend: {trend}.",
		"trend_improvement": "improvement",
		"trend_worsening": "worsening",
		"char_error_analysis_title": "\n--- Character Error Analysis ---",
		"insufficient_char_data": "No character has enough data for a detailed analysis.",
		"top5_critical_chars_title": "Top 5 critical characters (by error rate):",
		"critical_char_summary": "  - Character '{char}': Error rate {rate:.1f}% ({errors} errors on {sent} sends)",
		"evolution_focus_title": "\nEvolution focus for character '{char}':",
		"char_evolution_report_half1": "Error rate in first half: {rate:.1f}%.",
		"char_evolution_report_half2": "Error rate in second half: {rate:.1f}%.",
		"char_evolution_trend": "Trend for '{char}': {trend}.",
		"trend_worsening_or_stable": "worsening or stable",
		"no_advanced_data": "No data for advanced analysis.",
		"advanced_analysis_title": "--- Advanced Analysis ---",
		"overall_avg_accuracy": "Overall average accuracy: {acc:.1f}%.",
		"accuracy_trend_report": "Accuracy trend: from {half1:.1f}% (first half) to {half2:.1f}% (second half). Trend: {trend}.",
		"correlation_title": "\n--- Speed-Accuracy Correlation ---",
		"corr_insufficient_data": "insufficient data to calculate a correlation.",
		"corr_strong_negative": "strong negative correlation: as speed increases, accuracy tends to decrease.",
		"corr_moderate_negative": "moderate negative correlation: there is a slight tendency to be less accurate at higher speeds.",
		"corr_strong_positive": "strong positive correlation: as speed increases, accuracy also tends to improve.",
		"corr_moderate_positive": "moderate positive correlation: there is a slight tendency to be more accurate at higher speeds.",
		"corr_none": "no significant correlation between speed and accuracy.",
		"correlation_coefficient": "Correlation coefficient: {r:.2f}.",
		"correlation_interpretation": "Interpretation: {interpretation}",
		"duration_analysis_title": "\n--- Session Duration Analysis ---",
		"avg_duration": "Average session duration: {min} minutes and {sec} seconds.",
	...
	'it': {
		...
		"no_data_to_analyze": "Nessun dato da analizzare.",
		"summary_title": "--- Riepilogo Attività ---",
		"total_sessions_info": "Numero totale di sessioni analizzate: {count}",
		"period_covered_info": "Periodo coperto: {days} giorni",
		"first_session_info": "Prima sessione: {date}",
		"last_session_info": "Ultima sessione: {date}",
		"hourly_distribution_title": "\n--- Distribuzione Oraria delle Sessioni ---",
		"hourly_distribution_line": "  - Ore {hour_start:02d}:00: {count} sessioni ({percentage:.1f}%)",
		"hourly_peak_activity": "Picco di attività orario: {hour:02d}:00.",
		"weekly_distribution_title": "\n--- Distribuzione Settimanale ---",
		"weekly_distribution_line": "  - {day_name}: {count} sessioni ({percentage:.1f}%)",
		"weekly_peak_activity": "Picco di attività settimanale: {day_name}.",
		"monthly_distribution_title": "\n--- Distribuzione Mensile ---",
		"monthly_distribution_line": "  - {month_name}: {count} sessioni ({percentage:.1f}%)",
		"monthly_peak_activity": "Picco di attività mensile: {month_name}.",
		"giorni_settimana_dict": {"0": "Lunedì", "1": "Martedì", "2": "Mercoledì", "3": "Giovedì", "4": "Venerdì", "5": "Sabato", "6": "Domenica"},
		"mesi_anno_dict": {"1": "Gennaio", "2": "Febbraio", "3": "Marzo", "4": "Aprile", "5": "Maggio", "6": "Giugno", "7": "Luglio", "8": "Agosto", "9": "Settembre", "10": "Ottobre", "11": "Novembre", "12": "Dicembre"},
		"no_performance_data": "Nessun dato di performance da analizzare.",
		"wpm_analysis_title": "--- Analisi della Performance: Velocità (WPM) ---",
		"overall_avg_wpm": "Velocità media complessiva: {wpm:.1f} WPM.",
		"overall_wpm_consistency": "Consistenza (dev. std.): {std:.1f} WPM.",
		"wpm_trend_report": "Andamento: la media è passata da {half1:.1f} WPM (prima metà) a {half2:.1f} WPM (seconda metà). Tendenza: {trend}.",
		"trend_improvement": "miglioramento",
		"trend_worsening": "peggioramento",
		"char_error_analysis_title": "\n--- Analisi degli Errori sui Caratteri ---",
		"insufficient_char_data": "Nessun carattere ha dati sufficienti per un'analisi dettagliata.",
		"top5_critical_chars_title": "Primi 5 caratteri critici (per tasso di errore):",
		"critical_char_summary": "  - Carattere '{char}': Tasso errore {rate:.1f}% ({errors} errori su {sent} invii)",
		"evolution_focus_title": "\nApprofondimento sull'evoluzione del carattere '{char}':",
		"char_evolution_report_half1": "Tasso errore prima metà: {rate:.1f}%.",
		"char_evolution_report_half2": "Tasso errore seconda metà: {rate:.1f}%.",
		"char_evolution_trend": "Tendenza per '{char}': {trend}.",
		"trend_worsening_or_stable": "peggioramento o stabile",
		"no_advanced_data": "Nessun dato per l'analisi avanzata.",
		"advanced_analysis_title": "--- Analisi Avanzata ---",
		"overall_avg_accuracy": "Accuratezza media complessiva: {acc:.1f}%.",
		"accuracy_trend_report": "Andamento accuratezza: da {half1:.1f}% (prima metà) a {half2:.1f}% (seconda metà). Tendenza: {trend}.",
		"correlation_title": "\n--- Correlazione Velocità-Accuratezza ---",
		"corr_insufficient_data": "dati insufficienti per calcolare una correlazione.",
		"corr_strong_negative": "forte correlazione negativa: all'aumentare della velocità, l'accuratezza tende a diminuire.",
		"corr_moderate_negative": "correlazione negativa moderata: c'è una leggera tendenza a essere meno accurati a velocità più alte.",
		"corr_strong_positive": "forte correlazione positiva: all'aumentare della velocità, anche l'accuratezza tende a migliorare.",
		"corr_moderate_positive": "correlazione positiva moderata: c'è una leggera tendenza a essere più accurati a velocità più alte.",
		"corr_none": "nessuna correlazione significativa tra velocità e accuratezza.",
